...
import { NameConnectionEnum } from '../enums/name-connection';

@Injectable()
export class WorkStreamAuditService {
    constructor(@InjectConnection(NameConnectionEnum.NAME_CONNECTION) private connection: Sequelize) {}
    ...
    updateWorkStreamAudit(WorkStreamAuditId: number, workStreamResponse: WorkStreamResponse) {
